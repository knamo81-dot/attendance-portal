...
(function () {
  ...
  setTimeout(notifyAll, 800);
  setTimeout(notifyAll, 1600);
  setTimeout(notifyAll, 3000);
  setTimeout(notifyAll, 5000);
  setTimeout(notifyAll, 8000);
})();
